...
// For callback documentation and reference
public class MouseListener {
    ...
    public static void mousePosCallback(long window, double xPos, double yPos) {
        // set the last x and y before setting the new x and y
        get().lastX = get().xPos;
        get().lastY = get().yPos;
        get().xPos = xPos;
        get().yPos = yPos;
    ...
    public static void mouseButtonCallback(long window, int button, int action, int modifiers) {
        // modifiers are e.g. pressing CTRL while clicking a mouse button
